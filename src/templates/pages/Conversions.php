...
class Conversions implements TemplateInterface
{
    ...
    public function getView(): ViewInterface
    {
        ...
        if (isset($this->data['info'])) {
            foreach ($this->data['info'] as $infoId => $infoValue) {
                $content[] = ">\x1B[38;5;185m[{$infoId}]\x1B[38;5;255m\t<\x1B[1m{$infoValue}\x1B[0m>";
            }
        }
